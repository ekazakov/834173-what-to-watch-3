...
import {filmProps, AuthorizationStatus} from "../../consts.js";
import UserBlock from "../user-block/user-block.jsx"
import PropTypes from "prop-types";

const AddReview = (props) => {
  const {film, onSubmit, onTextChange, onRatingChange} = props;
      ...
      <div className="add-review">
        <form action="#" className="add-review__form" onSubmit={onSubmit}>
          ...
          <div className="add-review__text">
            <textarea className="add-review__textarea" name="review-text" id="review-text" placeholder="Review text" onChange={onTextChange}/>
